...
// 
//Параметры тела – это 5 целых числа(рост в сантиметрах, масса в килограммах, обхат талии, обхват груди, обхват бёдер).
// 
//                                   2 часть
// 
...
// 
//Блюдо(кулинарное) – это БЖУК(белки, жиры, углеводы и калории, описанные через структуру уже реализованную нами - БЖУК), 1 целое число(масса).
// 
...
//        5 строк(Учебное подразделение, Направление подготовки, Квалификация, Форма обучения, Группа), 2 целых числа(курс, уникальный номер).
// 
...
//	      Параметры тела(рост в сантиметрах, масса в килограммах, описанные через структуру уже реализованную нами - Параметры тела), целое число(возраст),  N строк(диагнозы).
